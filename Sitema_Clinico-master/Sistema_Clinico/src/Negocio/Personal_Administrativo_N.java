...
public class Personal_Administrativo_N implements CRUD<Personal_Administrativo> {
    ...
    @Override
    public Personal_Administrativo LeerID(int ID_PC) {
        PreparedStatement ps=null;
        ResultSet rs=null;
        Connection con=(Connection)Conexion.Conectar();
        String sql="SELECT PA.ID_Personal_Administrativo  FROM Personal_Administrativo PA WHERE PA.ID_Personal_Clinico=?;";
        try{
            ps=con.prepareStatement(sql);
            ps.setInt(1, ID_PC);
            rs=ps.executeQuery();
            ...
            Personal_Administrativo E_Personal_Administrativo=new Personal_Administrativo();
            E_Personal_Administrativo.setID_Personal_Administrativo(rs.getInt(1));
            return E_Personal_Administrativo;
        }
    ...
    public void Registrar(Personal_Administrativo obj) {
        ...
        ResultSet rs=null;
        Connection con=(Connection)Conexion.Conectar();
        String sql="INSERT INTO Personal_Administrativo(ID_Personal_Clinico) VALUES(?);";
        try {
